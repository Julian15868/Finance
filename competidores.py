...
def buscarPrimeraTandaCompetencia(accion):
...
def puntajesStocks(stocksTotales):
  puntajes = []
...
#####         SCRIPTS FIN       #####
#Creo que aca hasta el quit habia que borrar
...
for i in range(len(totalStocks)):
  ...
  try:
    stocks = buscarPrimeraTandaCompetencia(accion)
